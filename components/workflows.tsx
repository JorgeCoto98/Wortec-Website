        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <h2 className="font-nacelle animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 text-3xl font-semibold text-transparent md:text-4xl">
              Visualiza el desarrollo de tu producto
            </h2>
            <p className="text-lg text-indigo-200/65">
              Una interfaz simple y elegante para comenzar a colaborar con tu equipo en minutos. Se
              integra fácilmente con tu código y los lenguajes que ya usas.
            </p>
          </div>
          {/* Spotlight items */}
              ...
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Impulsa el desarrollo de tu producto con una plataforma de contenido que conecta
                    especificaciones e insights estratégicos.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Transforma tu flujo de desarrollo con IA diseñada para empresas: conecta
                    documentación clave con insights que generan impacto real.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Automatización dinámica que se adapta en tiempo real a tus procesos, datos y
                    equipos. Optimiza flujos sin rigidez, con inteligencia que aprende y responde al
